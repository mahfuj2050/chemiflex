...
const SaleNew: React.FC = () => {
  ...
  const [lines, setLines] = useState<Line[]>([
    { id: crypto.randomUUID(), productId: '', productName: '', unit: '', quantity: 1, unitPrice: 0 },
  ]);
        ...
        <div className="mx-auto w-full max-w-6xl">
          <div className="rounded-md border border-gray-200 bg-white">
            <div className="sticky top-0 z-10 flex items-center justify-between gap-3 border-b bg-white px-4 py-3 md:px-6 md:py-4">
              <h1 className="text-[22px] font-bold text-gray-900">New Sale</h1>
            ...
            <form onSubmit={onSubmit} className="space-y-4 p-4 md:p-6">
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
                <div className="md:col-span-2">
                  ...
                  <input className="w-full rounded-md border px-3 py-2 text-[13px] font-mono" placeholder="Auto if empty" value={uuid} onChange={(e)=> setUuid(e.target.value)} />
                </div>
                <div>
              ...
              <div>
                ...
                <input className="w-full rounded-md border px-3 py-2 text-[13px]" value={address} onChange={(e)=> setAddress(e.target.value)} placeholder="Billing address" />
              </div>
                    ...
                    <tbody>
                      {lines.map(l => (
                        <tr key={l.id} className="border-t">
                          ...
                          <td className="px-3 py-2 text-right">${lineTotal(l).toFixed(2)}</td>
